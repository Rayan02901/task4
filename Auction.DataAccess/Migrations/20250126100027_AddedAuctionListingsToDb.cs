...
{
    /// <inheritdoc />
    public partial class AddedAuctionListingsToDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 500000m, new DateTime(2025, 2, 2, 15, 45, 26, 509, DateTimeKind.Local).AddTicks(4622), null, false, false, 5000m, 1, 600000m, new DateTime(2025, 1, 27, 15, 45, 26, 509, DateTimeKind.Local).AddTicks(4606), 500000m, 0 },
                    { 2, 1000000m, new DateTime(2025, 2, 5, 15, 45, 26, 509, DateTimeKind.Local).AddTicks(4625), null, false, false, 10000m, 2, 1200000m, new DateTime(2025, 1, 28, 15, 45, 26, 509, DateTimeKind.Local).AddTicks(4625), 1000000m, 0 },
                    { 3, 300000m, new DateTime(2025, 2, 10, 15, 45, 26, 509, DateTimeKind.Local).AddTicks(4628), null, false, false, 3000m, 3, 350000m, new DateTime(2025, 1, 31, 15, 45, 26, 509, DateTimeKind.Local).AddTicks(4627), 300000m, 0 }
                });
