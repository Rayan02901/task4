...
namespace Auction.DataAccess.Migrations
{
    ...
    [Migration("20250126100027_AddedAuctionListingsToDb")]
    partial class AddedAuctionListingsToDb
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Auction.Models.AuctionListing", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2025, 2, 2, 15, 45, 26, 509, DateTimeKind.Local).AddTicks(4622),
                            IsBidStarted = false,
                            IsReservationPriceMet = false,
                            MinimumBidIncrement = 5000m,
                            PropertyId = 1,
                            ReservationPrice = 600000m,
                            StartDate = new DateTime(2025, 1, 27, 15, 45, 26, 509, DateTimeKind.Local).AddTicks(4606),
                            StartingBid = 500000m,
                            Status = 0
                        },
                        new
                        {
                            ...
                            EndDate = new DateTime(2025, 2, 5, 15, 45, 26, 509, DateTimeKind.Local).AddTicks(4625),
                            IsBidStarted = false,
                            IsReservationPriceMet = false,
                            MinimumBidIncrement = 10000m,
                            PropertyId = 2,
                            ReservationPrice = 1200000m,
                            StartDate = new DateTime(2025, 1, 28, 15, 45, 26, 509, DateTimeKind.Local).AddTicks(4625),
                        ...
                        new
                        {
                            ...
                            EndDate = new DateTime(2025, 2, 10, 15, 45, 26, 509, DateTimeKind.Local).AddTicks(4628),
                            IsBidStarted = false,
                            IsReservationPriceMet = false,
                            MinimumBidIncrement = 3000m,
                            PropertyId = 3,
                            ReservationPrice = 350000m,
                            StartDate = new DateTime(2025, 1, 31, 15, 45, 26, 509, DateTimeKind.Local).AddTicks(4627),
                            StartingBid = 300000m,
                            Status = 0
                        });
                });
