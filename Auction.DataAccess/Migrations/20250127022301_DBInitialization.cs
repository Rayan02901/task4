    ...
    public partial class DBInitialization : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 500000m, new DateTime(2025, 2, 3, 8, 7, 59, 764, DateTimeKind.Local).AddTicks(1416), null, false, false, 5000m, 1, 600000m, new DateTime(2025, 1, 28, 8, 7, 59, 764, DateTimeKind.Local).AddTicks(1377), 500000m, 0 },
                    { 2, 1000000m, new DateTime(2025, 2, 6, 8, 7, 59, 764, DateTimeKind.Local).AddTicks(1426), null, false, false, 10000m, 2, 1200000m, new DateTime(2025, 1, 29, 8, 7, 59, 764, DateTimeKind.Local).AddTicks(1424), 1000000m, 0 },
                    { 3, 300000m, new DateTime(2025, 2, 11, 8, 7, 59, 764, DateTimeKind.Local).AddTicks(1433), null, false, false, 3000m, 3, 350000m, new DateTime(2025, 2, 1, 8, 7, 59, 764, DateTimeKind.Local).AddTicks(1431), 300000m, 0 }
                });
